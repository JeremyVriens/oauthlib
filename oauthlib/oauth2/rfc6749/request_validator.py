...
class RequestValidator:
    ...
    async def get_default_redirect_uri(self, client_id, request, *args, **kwargs) -> str:
    ...
    async def invalidate_authorization_code(
    ...
    async def validate_client_id(self, client_id, request, *args, **kwargs) -> bool:
    ...
    async def validate_redirect_uri(
            self, client_id, redirect_uri, request, *args, **kwargs) -> bool:
    ...
    async def validate_response_type(
            self, client_id, response_type, client, request, *args, **kwargs) -> bool:
    ...
    async def is_pkce_required(self, client_id, request) -> bool:
    ...
    async def get_code_challenge(self, code, request) -> Optional[str]:
